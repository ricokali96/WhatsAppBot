...
#options.add_argument(r"--user-data-dir=C:\Users\Enrico\AppData\Local\Google\Chrome\User Data\Default")
...
time.sleep(random.randint(40,45)) #tempo para escanear QR code
...
for i, mensagem in enumerate(contatos_df['Mensagem']):
    ...
    if dia == date_time:
        ...
        time.sleep(random.randint(10,15)) #tempo para envio da mensagem
