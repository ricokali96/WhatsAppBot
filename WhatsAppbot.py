...
options.add_argument(r"--user-data-dir=C:\Users\Lira\AppData\Local\Google\Chrome\User Data\Default")
#while len(navegador.find_element_by_id("side")) < 1:
    #time.sleep(5)
navegador = webdriver.Chrome(executable_path=r'./chromedriver.exe', chrome_options=options)
navegador.get("https://web.whatsapp.com/")
time.sleep(60) #tempo para escanear QR code
...
for i, mensagem in enumerate(contatos_df['Mensagem']):
    ...
    try: #tenta apertar enter, se nao der avisa que deu errado
        navegador.find_element_by_xpath('//*[@id="main"]/footer/div[1]/div/div/div[2]/div[1]/div/div[2]').send_keys(Keys.ENTER) # copiamos o XPATH da caixa de texto e vamos dar enter
    except:
        print(f"Numero errado de {pessoa}, ver se {numero} está correto")
    time.sleep(random.randint(25,30)) #tempo para envio da mensagem
